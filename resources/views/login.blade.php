    ...
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3>Connexion à <strong>CTF by LIS</strong></h3>
            <p class="mb-4">Association liée à 42Perpignan</p>
            <form action="{{ route("auth_post", ["type" => "login"]) }}" method="POST">
                @csrf
                @method("POST")
              ...
              <div class="d-flex mb-5 align-items-center">
                <span class="ml-auto"><a href="{{ route("auth_view", ["type" => "register"]) }}">Inscription</a></span> 
              </div>
